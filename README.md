...
* Depending on the features you want to use, you may need some third-party software, such as DataGrip (payed) or [MySQL](https://dev.mysql.com/downloads/workbench/) Workbench (free) for data modeling, SQL development, and comprehensive administration for the system data.
