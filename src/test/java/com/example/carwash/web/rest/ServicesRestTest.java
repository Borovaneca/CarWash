...
class ServicesRestTest {
    ...
    void getServices() throws Exception {
        String expected = "[{\"id\":1,\"name\":\"Interior Detailing\",\"description\":\"Get the inside of your vehicle detailed with a thorough vacuum, windows cleaned, mats shampooed and a wipe down and polish of all interior surfaces.\",\"price\":\"40.0\",\"urlVideo\":\"pVWPOBmOKuM\"},{\"id\":2,\"name\":\"Express Wash\",\"description\":\"For a quick but thorough cleaning, our express wash hits all the key areas - exterior wash and rinse, towel dry and vacuum. Great for the busy driver on the go.\",\"price\":\"15.0\",\"urlVideo\":\"UJ54Kxk5LsA\"},{\"id\":3,\"name\":\"The Works Wash\",\"description\":\"Our signature wash includes a presoak, tri-color foam bath, high-pressure rinse, hand wax and interior vacuum and windows cleaned. Your car will look showroom new!\",\"price\":\"20.0\",\"urlVideo\":\"eWUxqVFBq74\"}]";
